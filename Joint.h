...
public:
	...
	Joint(uint8_t aPin, uint16_t aPos);
	Joint(uint8_t aPin, uint16_t aPos, uint16_t aLength, uint16_t aMinMicros, float aMinAngle, uint16_t aMaxMicros, float aMaxAngle);
	Joint(uint8_t aPin, uint16_t aPos, uint16_t aLength, uint16_t aOffset, uint16_t aMinMicros, float aMinAngle, uint16_t aMaxMicros, float aMaxAngle);
	...
	void followTheStick(int aReading, int aCenter = 0);
	void useStick(int);
